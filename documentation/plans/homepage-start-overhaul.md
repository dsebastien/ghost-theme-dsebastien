...
- [ ] #1 Must Have Obsidian Plugins 2026 → edit note · verify diff · republish · confirm live
- [ ] #2 Synchronize and backup → …
- [ ] #3 Books and summaries → …
- [ ] #4 Ultimate Beginner's Guide → …
- [ ] #5 AI 16 use cases → …
